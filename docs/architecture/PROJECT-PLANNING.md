...
| 3 — VirusTotal | ✅ **terminée** | — | [#93](https://github.com/imanehajjou2025-lab/smartsoc-enterprise/pull/93) | Connecteur à la demande (cache TTL 24h + `@CircuitBreaker`+`@RateLimiter`), verdict dérivé des compteurs réels par « pire cas gagne », 524 tests backend verts (+35) ; bug transactionnel réel corrigé (`noRollbackFor`) trouvé par test WireMock ; ACL vérifiée sur 2 échantillons réels (IP + domaine) — voir journal PFE, 2026-08-09. Frontend (déclencheur à la demande) non encore évalué |
| 4 — OpenSearch | ⬜ | — | — | — |
| 5 — Actions réelles | ⬜ | — | — | — |

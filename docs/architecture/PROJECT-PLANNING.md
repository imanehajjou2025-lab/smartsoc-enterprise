...
| 5 — Actions réelles | 🔶 **en cours** (1/2 connecteurs : Wazuh terminé) | — | [#105](https://github.com/imanehajjou2025-lab/smartsoc-enterprise/pull/105) [#107](https://github.com/imanehajjou2025-lab/smartsoc-enterprise/pull/107) [#109](https://github.com/imanehajjou2025-lab/smartsoc-enterprise/pull/109) [#111](https://github.com/imanehajjou2025-lab/smartsoc-enterprise/pull/111) | Contrôle d'agents Wazuh **terminé** : redémarrage et active-response `firewall-drop`/blocage d'IP, backend + frontend pour les deux. Identifiants dédiés `smartsoc-actuator` (portée minimale, confirmés en réel), garde-fous non négociables tenus et partagés entre les deux actions (cible confirmée par saisie exacte, motif obligatoire, plafond 3/h compté séparément par type d'action, aucun retry, audit nominatif systématique), 572 tests backend + 51 tests frontend verts. Vérifié de bout en bout au navigateur (mode simulation, jamais de vraie action déclenchée). Reste : Shuffle (2ᵉ connecteur de la phase) — voir journal PFE, 2026-08-10 |

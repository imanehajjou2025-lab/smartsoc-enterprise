...
| 5 — Actions réelles | 🔶 **en cours** (1/2 connecteurs complet) | — | [#105](https://github.com/imanehajjou2025-lab/smartsoc-enterprise/pull/105) [#107](https://github.com/imanehajjou2025-lab/smartsoc-enterprise/pull/107) | Contrôle d'agents Wazuh (redémarrage), backend + frontend : identifiants dédiés `smartsoc-actuator` (portée minimale, confirmés en réel), garde-fous non négociables tenus (cible confirmée par saisie exacte, motif obligatoire, plafond 3/h, aucun retry, audit nominatif systématique), 560 tests backend + 48 tests frontend verts. Vérifié de bout en bout au navigateur (mode simulation, jamais de vrai redémarrage déclenché). Restent : active-response, Shuffle — voir journal PFE, 2026-08-10 |

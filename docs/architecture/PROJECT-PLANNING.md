...
| 5 — Actions réelles | 🔶 **en cours** (1/2 connecteurs, backend seul) | — | [#105](https://github.com/imanehajjou2025-lab/smartsoc-enterprise/pull/105) | Contrôle d'agents Wazuh (redémarrage) : identifiants dédiés `smartsoc-actuator` (portée minimale, confirmés en réel), garde-fous non négociables tenus (cible confirmée, motif obligatoire, plafond 3/h, aucun retry, audit nominatif systématique), 560 tests backend verts (+17). Restent : bouton frontend, active-response, Shuffle — voir journal PFE, 2026-08-10 |

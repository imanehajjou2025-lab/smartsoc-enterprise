...
class AuditLogQueryTest {
    ...
    void allFiltersAreCarriedAsGiven() {
        ...
        AuditLogQuery query = new AuditLogQuery(AuditAction.LOGIN_FAILED, "admin", from, to,
                "ASSET", "some-id", PageQuery.of(0, 25));
        ...
        assertThat(query.targetType()).isEqualTo("ASSET");
        assertThat(query.targetId()).isEqualTo("some-id");

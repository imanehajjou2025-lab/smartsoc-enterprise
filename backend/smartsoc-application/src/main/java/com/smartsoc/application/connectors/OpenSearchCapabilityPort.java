...
/**
 * Détecte la version réelle de l'Indexer OpenSearch et les capacités qui
 * en découlent (ADR-014 §6.5, {@code CapabilityProbe} de
 * {@code CONNECTORS-REFERENCE.md} §1). Jamais de valeur supposée.
 */
public interface OpenSearchCapabilityPort {
